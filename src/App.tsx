...
// import { RolProtegida } from "cpm_components/components/RolProtegida";
  ...
  const rutas = createBrowserRouter(
    createRoutesFromElements(
      <>
        ...
        <Route path="/login" element={(esAutenticado) ? <Navigate to="/dashboard" replace /> : <Login />} />
